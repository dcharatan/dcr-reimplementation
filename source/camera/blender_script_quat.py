...
scene.render.resolution_x = int(sys.argv[-9])
scene.render.resolution_y = int(sys.argv[-8])
...
new_camera_obj.rotation_quaternion = (w, x, y, z)
...
bpy.context.scene.render.filepath = sys.argv[-10]
